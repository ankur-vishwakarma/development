	...
	<div class="header">
		...
		<div class="web_search">
		 	<form>
				...
				<input action="product.jsp" type="submit" value=" " />
			</form>
	    </div>						
		<div class="clear"></div>
	</div>	
...
<div class="main">
	...
	<div class="single">
			...
			<div class="span1_of_1">
				...
				<div class="product-view">
				    ...
				    <div class="product-image"> 
				        <a class="cs-fancybox-thumbs cloud-zoom" rel="adjustX:30,adjustY:0,position:'right',tint:'#202020',tintOpacity:0.5,smoothMove:2,showTitle:true,titleOpacity:0.5" data-fancybox-group="thumb" href=<%=imgl %> title=<%=name %> alt=<%=name %>>
				           	<img src=<%=imgl %> alt=<%=name %> title=<%=name %> />
				        </a>
				   </div>
					<script type="text/javascript">
						<%-- var prodGallery = jQblvg.parseJSON('{"prod_1":{"main":{"orig":<%=imgl %>,"main":<%=imgl %>,"thumb":<%=imgs %>,"label":""},"gallery":{"item_0":{"orig":<%=imgl %>,"main":<%=imgs %>,"thumb":<%=imgs %>,"label":""},"item_1":{"orig":<%=imgl %>,"main":<%=imgl %>,"thumb":<%=imgs %>,"label":""},"item_2":{"orig":<%=imgl %>,"main":<%=imgl %>,"thumb":<%=imgs %>,"label":""},"item_3":{"orig":"images/0001-3.jpg","main":"images/large/0001-3.jpg","thumb":"images/small/0001-3.jpg","label":""},"item_4":{"orig":"images/0001-4.jpg","main":"images/large/0001-4.jpg","thumb":"images/small/0001-4.jpg","label":""}},"type":"simple","video":false}}'),
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					<h3><%=name %></h3>
					<h5><%=price %> <span>1099</span>  <a href="#">click for offer</a></h5>
					<div class="available">
						 <div class="btn_form">
		...
		<!-- start left_sidebar -->
			<div class="left_sidebar">
				...
				<div class="left_products">
					...
					<div class="left_text">
						<p><a href="fetchdetails.jsp?i=<%=id1%>"><%=name1 %></a></p>
						<span class="line"><%=price1+200%></span>
						<span><%=price1%></span>
					</div>
					<div class="clear"></div>
				</div>
				<div class="left_products">
					...
					<div class="left_text">
						<p><a href="fetchdetails.jsp?i=<%=id2%>"><%=name2 %></a></p>
						<span class="line"><%=price2+500%></span>
						<span><%=price2%></span>
					</div>
					<div class="clear"></div>
				</div>
				<div class="left_products">
					...
					<div class="left_text">
						<p><a href="fetchdetails.jsp?i=<%=id3%>"><%=name3 %></a></p>
						<span class="line"><%=price3+500%></span>
						<span><%=price3%></span>
					</div>
					<div class="clear"></div>
				</div>
...
<div class="footer">
	...
	<div class="span_of_3">
		<div class="span1_of_3">
			<h3>site developed and maintained by:</h3>
			<p>Ankur Vishwakarma,NIT mizoram</p><br>
			<p>contact: prince.ankur.pv@gmail.com</p>
			</div>
		<div class="span1_of_3">
